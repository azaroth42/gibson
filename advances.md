...
•	Assist: Help another character (Special)
...
Out of the Frying Pan: When you take damage, you can reduce the damage by 5 by voluntarily taking a complication of the GM’s choice.

Reckless:  Take +1 forward, +1 to damage if you rush in heedless of any danger

Criticals: Whenever you roll Attack, on a natural 12 you do maximum normal damage. However on a natural 2, the GM gets to make two moves against you.
...
[1] specialized: Specialized: You have a specialization from the list below. If you are researching a topic you have a specialization for, before you roll, choose to either take +1 on the roll, or if successful gain an additional [intel].
•	Weapons and Armor
•	Cybernetics
...
•	Corporate Politics, People and Places
    [2] specialized2: Gain another specialization (repeatable)
...
For each piece of cyberware installed beyond the limit, the GM will give you an ongoing -1 to another Stat at the beginning of each session. 

Tough: Jitters, freezing up, coughing up blood, or worse carbon lubricant … you’ve pushed your body beyond what it can handle.
Cool: You’re losing your edge, trying to keep the mind, metal and meat all working together. The stress is degrading your ability to keep your emotions under control and think clearly.
...
With either Tactical AI or +HUD on SynthSenses, allows you to roll with Advantage on Mix It Up for +linked weapons and deal an extra +d6 damage.
...
Pistol: +d6
Heavy Pistol: +d6+2
SMG: +d6+2, +target or +reroll
Assault Rifle: +2d6+2, +target or +reroll
Shotgun: +2d6, +slow
Sniper Rifle: +3d6, +reroll, +slow
...
Deck:
* Memory: 1,2,3 (number of programs)
